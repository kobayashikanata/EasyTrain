...
public class CompatSpinner2 extends AppCompatSpinner {

    public CompatSpinner2(Context context) {
        super(context);
    }

    public CompatSpinner2(Context context, AttributeSet attrs) {
        super(context, attrs);
    }

    public CompatSpinner2(Context context, AttributeSet attrs, int defStyleAttr) {
